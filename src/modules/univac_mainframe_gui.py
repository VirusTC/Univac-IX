...
# Ensure runtime directories exist at the repo root
...
class MainframeTerminalGUI:
    ...
    def load_hierarchical_structures(self):
        """Scans the repository root for site and room templates."""
        self.sites = []
        self.rooms = {}
    ...
    def draw_terminal_dashboard(self, stdscr):
        ...
        sb_attr = curses.color_pair(2) if self.active_panel == 1 else curses.A_NORMAL
        ...
        instructions = "[TAB]: Switch Panels | [SPACE]: Toggle Status | [A]: Add to Canvas | [R]: Remove Row | [Q]: Exit"
